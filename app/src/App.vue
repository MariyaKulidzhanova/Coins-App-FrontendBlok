  ...
  <div class="budget-app">
    <div class="top">
      <section class="section income">
        <h2>Ваши доходы</h2>
        <div class="section-box"><input type="number" v-model.number="income" placeholder="Введите доход"></div>
      </section>
      <section class="section dream">
        <h2>Цель на мечту</h2>
        <div class="section-box"><input type="number" v-model.number="goal" placeholder="Введите доход"></div>
      </section>
    </div>
